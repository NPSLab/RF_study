         ...
         for(int tree_num = 0; tree_num < num_of_trees; ++tree_num){
            ...
            while (true){
              ...
              //Mod
                ...
                while (true){
                  //Mod
                    unsigned short feature_id = subtree_node_is_leaf_feature_id_list[curr_node] >> 1;
                    float node_value    = subtree_node_value_list[curr_node];
                    unsigned short is_tree_leaf    = subtree_node_is_leaf_feature_id_list[curr_node] & 0x1;
