...
#MODIFY
    ...
    def build_subtree(self,node_id,subtree_node_id,depth, max_percent_leaf):
        if int(node_id) == 0:
            level = 0
            curr_node = 0
            nodes_to_check = 1
...
for conf in configs:
    ...
    for _subtree_depth in range(9,10): 
        for max_percent_leaf in PL_RANGE:
            forest_trees = []
            #_subtree_depth = 2 
            ...
            #    csr_decision_tree = [num_of_nodes, node_list, edge_list, node_is_leaf, node_features, node_values]
                ...
                while len(pending_subtrees_to_build) > 0:
                    ...
                    subtree.build_subtree(node_id=ori_node_id,subtree_node_id=0,depth=0, max_percent_leaf=max_percent_leaf)
