...
#MODIFY
    ...
    def build_subtree(self,node_id,subtree_node_id,depth, max_percent_leaf=0.3,use_pl=False):
...
for conf in configs:
    ...
    treename = "clustered_fixed_"+DATASET_NAME+"_td"+str(_max_depth)+"_ne"+str(_n_estimators) 
        ...
        for mpl in PL_RANGE:
            ...
            #    csr_decision_tree = [num_of_nodes, node_list, edge_list, node_is_leaf, node_features, node_values]
                ...
                while len(pending_subtrees_to_build) > 0:
                    ...
                    subtree.build_subtree(node_id=ori_node_id,subtree_node_id=0,depth=0, max_percent_leaf=mpl)
            ...
            treename = "clustered_fixed_"+DATASET_NAME+"_td"+str(_max_depth)+"_ne"+str(_n_estimators) + "_sd" + str(_subtree_depth)
