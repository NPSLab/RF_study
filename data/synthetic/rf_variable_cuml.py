...
from data.synthetic.rf_layout_cuml import CUML_ITERATIONS
...
for conf in configs:
    ...
    for _subtree_depth in range(4,5): 
        ...
        treename = "clustered_variable_"+DATASET_NAME+"_td"+str(_max_depth)+"_ne"+str(_n_estimators) + "_sd" + str(_subtree_depth)
