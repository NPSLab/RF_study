...
do
  ...
  cp ./input_files/susy_format/clusteredSUSY_td45_ne${ne}_csr.txt ./treefile_csr.txt
  ./gpu/rf_gpu_csr 45

  echo
  echo "TTT45: test subtree depth 5"
  cp ./input_files/susy_format/clusteredSUSY_td45_ne${ne}_sd4_hier.txt ./treefile_hier.txt
  ./gpu/rf_gpu_iter 45
done