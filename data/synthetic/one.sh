...
do
  ...
  cp ./input_files/clustered_metadata_SUSY_td${tree_depth}_ne50_csr.txt ./treefile_csr.txt
  ./gpu/rf_gpu_csr ${tree_depth}

  echo
  echo "TTT$tree_depth: test subtree depth 5"
  cp ./input_files/clustered_metadata_SUSY_td${tree_depth}_ne50_sd4_hier.txt ./treefile_hier.txt
